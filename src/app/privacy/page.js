      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto bg-base-100 p-8 md:p-12 rounded-lg shadow-lg">
          ...
          <div className="prose max-w-none dark:prose-invert">
            ...
            <h2 className="text-2xl font-bold mt-6">4. How We Protect Your Information</h2>
            <p>
              We use administrative, technical, and physical security measures to help protect your personal information. While we have taken reasonable steps to secure the personal information you provide to us, please be aware that despite our efforts, no security measures are perfect or impenetrable, and no method of data transmission can be guaranteed against any interception or other type of misuse.
            </p>

            <h2 className="text-2xl font-bold mt-6">5. Use of Cookies</h2>
            <p>
            ...
            <p>
              You have the right to access, update, or delete the personal information we have on you. You can review and change your information at any time by logging into your account and visiting your profile page.
            </p>
            
            <h2 className="text-2xl font-bold mt-6">7. Changes to This Privacy Policy</h2>
            <p>
            ...
            <h2 className="text-2xl font-bold mt-6">8. Contact Us</h2>
            <p>
              If you have questions or comments about this Privacy Policy, please contact us at:
              <br />
              <strong>Email:</strong> privacy@nextcart.com
              <br />
